...
#align(center)[
  #figure(image("img/ipfs.png", width: 100%), caption: [IPFS Distributed Network])<ipfs>
]

The integrity and immutability of data are secured through robust cryptographic mechanisms in the blockchain system. This fosters secure transactions and encourages trust among participants in various digital ecosystems @BlockchainInEducationASystematicReviewAndPracticalCaseStudies.
...
#align(center)[
  #figure(image("img/sivil.png", width: 100%), caption: [SIVIL System])<sivil>
]
